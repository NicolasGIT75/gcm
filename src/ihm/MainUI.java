...
public class MainUI extends JFrame {
	...
	public MainUI() {
		...
		btnUpdate.addActionListener(new ActionListener() {
			private JTextComponent textAreaAdrEdit;
		...
		btnValideModification.setBounds(409, 421, 85, 21);
		panelModification.add(btnValideModification);
		
		JButton btnValideRest = new JButton("Annuler");
		btnValideRest.addActionListener(new ActionListener() {
		...
		btnValideRest.setBounds(532, 422, 97, 25);
		panelModification.add(btnValideRest);
